...
df= pd.read_csv(r"C:\Users\Ayushi\Downloads\precily.csv")
print(df.head())

sns.countplot(df.category)
plt.xlabel('Label')
plt.title('Number of different categories')

num_missing_desc = df.isnull().sum()  # No. of values with msising descriptions
